...
# k3s's kubelet resolv-conf at the container's routable eth0 IP.
#
...
# Execute k3s, passing the custom resolv.conf as a kubelet argument.
# k3s v1.35.2+ removed the top-level --resolv-conf flag; it must now be
# passed through to kubelet via --kubelet-arg. See #696.
